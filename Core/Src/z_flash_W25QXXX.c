...
#define SPI_IS_BUSY 	(HAL_GPIO_ReadPin(FLASH_SPI2_CS_GPIO_Port, FLASH_SPI2_CS_Pin)==GPIO_PIN_RESET)
...
//	HAL_GPIO_WritePin(FLASH_CS_GPIO_Port, FLASH_CS_Pin, GPIO_PIN_SET);	//unselect
	HAL_GPIO_WritePin(FLASH_SPI2_CS_GPIO_Port, FLASH_SPI2_CS_Pin, GPIO_PIN_SET);	//unselect
